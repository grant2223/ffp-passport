...
(function () {
  ...
  function injectCss() {
    ...
    s.textContent = [
      ...
      '.ffp-bell-badge{position:absolute;top:-4px;right:-4px;min-width:17px;height:17px;padding:0 4px;border-radius:9px;background:var(--ffp-yellow,#FFCC00);color:#000;font-size:10px;font-weight:800;line-height:1;display:flex;align-items:center;justify-content:center;box-shadow:0 0 0 2px var(--ffp-bg-2,#0f1e2e);}',
      '.ffp-notif-pop{position:fixed;width:340px;max-width:calc(100vw - 24px);max-height:440px;background:var(--ffp-bg-2,#0f1e2e);border:1px solid var(--ffp-border-mid,rgba(43,168,224,.22));border-radius:14px;box-shadow:0 18px 50px rgba(0,0,0,.5);z-index:90;display:flex;flex-direction:column;overflow:hidden;}',
      '.ffp-notif-head{display:flex;align-items:center;justify-content:space-between;padding:14px 16px;border-bottom:1px solid var(--ffp-border,rgba(43,168,224,.1));}',
      '.ffp-notif-head .t{font-size:13px;font-weight:800;color:var(--ffp-text,#e8eef4);}',
      '.ffp-notif-head .c{font-size:11px;font-weight:700;color:var(--ffp-blue,#2ba8e0);cursor:pointer;}',
      '.ffp-notif-head .c:hover{color:var(--ffp-yellow,#FFCC00);}',
      '.ffp-notif-list{overflow-y:auto;padding:6px 0;}',
      '.ffp-notif-list::-webkit-scrollbar{width:0;display:none;}',
      '.ffp-notif-item{display:flex;gap:11px;padding:11px 16px;border-bottom:1px dashed var(--ffp-border,rgba(43,168,224,.1));cursor:pointer;}',
      '.ffp-notif-item:last-child{border-bottom:none;}',
      '.ffp-notif-item:hover{background:rgba(43,168,224,.06);}',
      '.ffp-notif-item.unseen{background:rgba(255,204,0,.05);}',
      '.ffp-notif-ic{width:34px;height:34px;border-radius:9px;background:rgba(43,168,224,.12);color:var(--ffp-blue,#2ba8e0);display:flex;align-items:center;justify-content:center;flex-shrink:0;}',
      '.ffp-notif-ic.green{background:rgba(74,222,128,.12);color:var(--ffp-green,#4ade80);}',
      '.ffp-notif-ic.yellow{background:rgba(255,204,0,.12);color:var(--ffp-yellow,#FFCC00);}',
      '.ffp-notif-ic .ms{font-size:18px;}',
      '.ffp-notif-tx{flex:1;min-width:0;}',
      '.ffp-notif-tx .m{font-size:12.5px;font-weight:600;color:var(--ffp-text,#e8eef4);line-height:1.4;}',
      '.ffp-notif-tx .ti{font-size:10px;font-weight:700;color:var(--ffp-text-muted,#8a99a8);margin-top:3px;letter-spacing:.3px;}',
      '.ffp-notif-empty{padding:34px 20px;text-align:center;color:var(--ffp-text-muted,#8a99a8);font-size:13px;font-weight:600;}',
